        ...
        <div class="mx-auto border my-5 py-3 px-3 form">
            <form:form action="/bank/api/auth/registration" method="POST" modelAttribute="client">
                ...
                <div class="mb-3">
                    ...
                    <form:input path="phoneNumber" type="text" class="form-control" aria-describedby="usernameHelp"/>
                ...
                <div class="mb-3">
                    ...
                    <div id= "usernameHelp" class="form-text" style="color: #fff3cd">This value will be used for authorization</div>
                </div>
                <div class="mb-3">
                    <form:label path="password" class="form-label">Password:</form:label>
                    <form:input path="password" type="text" class="form-control" aria-describedby="usernameHelp"/>
                    <form:errors path="password" cssClass="text-danger"/>
                    <div id="passwordHelp" class="form-text" style="color: #fff3cd">This value will be used for authorization</div>
                </div>
                <div class="my_button">
